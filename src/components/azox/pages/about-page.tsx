...
const FOUNDER_SOCIALS = [
  ...
  },
  {
    ...
    icon: (
      <svg viewBox="0 0 24 24" className="size-5 fill-current">
        <path d="M12.206 1c.577 0 2.552.223 4.02 2.18.99 1.348 1.248 3.06.762 5.058-.083.343.204.512.427.617 1.286.606 2.289 1.184 2.289 2.464 0 1.1-.93 1.55-1.822 1.98-.354.165-.698.324-.977.524-.19.137-.283.347-.246.57.038.227.22.41.485.505.61.22 1.104.337 1.502.337.83 0 1.227-.427 1.227-.427.183-.183.427-.244.671-.122.244.122.366.39.305.64-.183.744-.916 1.855-2.746 2.355-.732.2-1.16.52-1.374.81-.214.29-.244.58-.244.733 0 .092.012.213.04.35.1.48.1.77-.061 1.01-.183.27-.55.37-.976.27-.52-.123-1.08-.49-1.707-.49-.55 0-.976.245-1.43.52-.52.32-1.1.69-2.155.69-1.04 0-1.62-.36-2.14-.69-.46-.28-.89-.52-1.45-.52-.61 0-1.19.367-1.71.49-.43.1-.79 0-.98-.27-.16-.24-.16-.53-.06-1.01.03-.14.04-.26.04-.35 0-.15-.03-.44-.24-.73-.22-.29-.64-.61-1.38-.81-1.83-.5-2.56-1.61-2.74-2.36-.06-.25.06-.52.3-.64.25-.12.49-.06.67.12 0 0 .4.43 1.23.43.4 0 .89-.12 1.5-.34.27-.09.45-.28.49-.5.04-.22-.06-.44-.25-.57-.28-.2-.62-.36-.98-.52-.89-.43-1.82-.88-1.82-1.98 0-1.28 1-1.86 2.29-2.46.22-.11.51-.28.43-.62-.49-1.99-.23-3.71.76-5.06C9.24 1.22 11.22 1 11.8 1h.406z" />
      </svg>
    ),
  },
];

      ...
      <div className="mx-auto flex w-full max-w-md items-stretch justify-between px-2 pb-[max(env(safe-area-inset-bottom),0.5rem)] pt-2">
        {TABS.map((tab) => {
          ...
          return (
            ...
            >
              <span className="flex size-9 items-center justify-center rounded-xl transition-all group-data-[status=active]:bg-accent/15 group-data-[status=active]:shadow-[0_0_0_1px_rgba(163,230,53,0.25),0_0_24px_rgba(163,230,53,0.18)]">
